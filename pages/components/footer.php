...
<button class="btn footer_button_browse" onclick="window.location='./browse_recent.php';">Browse Existing Library</button><br>
<button class="btn footer_button_upload" onclick="window.location='./upload.php';">Upload Your Own File</button>
</div>
</div>
...
<p><a href="./" <?php echo (($pagename=="index")?'class="footer_links_active"':''); ?>>Home </a>&nbsp;|&nbsp;<a href="./aboutus.php" <?php echo (($pagename=="aboutus")?'class="footer_links_active"':''); ?>> About </a>&nbsp;|&nbsp;<a href="./browse_recent.php" <?php echo ((substr($pagename,0,6)=="browse")?'class="footer_links_active"':''); ?>> Browse </a>&nbsp;|&nbsp;<a href="./contactus.php" <?php echo (($pagename=="contactus")?'class="footer_links_active"':''); ?>> Contact</a></p>
</div><br>
<div class="footer_links_search">
<form class="form-inline my-2 my-lg-0">

        <div class="input-group">
            <input type="text" class="form-control footer_search_input" type="search" placeholder="Search Scores" aria-label="Search">
...
<div class="footer_reach_email"><a href="./contactus.php" class="<?php echo (($pagename=="contactus")?'footer_email_link_active':'footer_email_link'); ?>">info@music2score.com</a></div>
