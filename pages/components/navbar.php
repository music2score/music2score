    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown navbar_dropdown_container">
                ...
                <div class="dropdown-menu navbar_account_dropdown" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item navbar_dropdown_item" id="navregisterbtn" href="./register.php">Register</a>
                    <a class="dropdown-item navbar_dropdown_item" id="navloginbtn" href="./login.php">Login</a>
                </div>
            </li>
            <?php } ?>
        </ul>
